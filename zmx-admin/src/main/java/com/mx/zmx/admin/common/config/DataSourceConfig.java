package com.mx.zmx.admin.common.config;
...
@MapperScan(basePackages =
        {"com.mx.zmx.admin.**.mapper"
        ,"com.mx.zmx.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.mx.zmx.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            "com.mx.zmx.admin.model," +
            "com.mx.zmx.admin.rmp.model," +
            "com.mx.zmx.model";//逗号分隔多个
